...
const ELEMENTS_DATA = [
  // ===== 第1周期 =====
  {
    z: 1, symbol: 'H', name: '氢', nameEn: 'Hydrogen',
    category: 'nonmetal', period: 1, group: 1, difficulty: 1,
    color: '#eab308', badge: '💎',
    desc: '宇宙中最丰富的元素，水的组成成分'
  },
  {
    z: 2, symbol: 'He', name: '氦', nameEn: 'Helium',
  ...
  // 镧系元素 (57-71)
  {
    z: 57, symbol: 'La', name: '镧', nameEn: 'Lanthanum',
    category: 'lanthanide', period: 6, group: 3, difficulty: 4,
    color: '#d4a017', badge: '🌟',
    desc: '镧系元素之首，用于光学玻璃和催化剂'
  },
  {
    z: 58, symbol: 'Ce', name: '铈', nameEn: 'Cerium',
    category: 'lanthanide', period: 6, group: 3, difficulty: 4,
    color: '#d4a017', badge: '🌟',
    desc: '最丰富的稀土元素，用于汽车尾气催化和打火石'
  },
  {
    z: 59, symbol: 'Pr', name: '镨', nameEn: 'Praseodymium',
    category: 'lanthanide', period: 6, group: 3, difficulty: 4,
    color: '#d4a017', badge: '🌟',
    desc: '用于制造高强度永磁体和特种玻璃'
  },
  {
    z: 60, symbol: 'Nd', name: '钕', nameEn: 'Neodymium',
    category: 'lanthanide', period: 6, group: 3, difficulty: 4,
    color: '#d4a017', badge: '🌟',
    desc: '制造强力钕铁硼永磁体，广泛用于电机和耳机'
  },
  {
    z: 61, symbol: 'Pm', name: '钷', nameEn: 'Promethium',
    category: 'lanthanide', period: 6, group: 3, difficulty: 4,
    color: '#d4a017', badge: '🌟',
    desc: '唯一具有放射性的镧系元素，用于核电池'
  },
  {
    z: 62, symbol: 'Sm', name: '钐', nameEn: 'Samarium',
    category: 'lanthanide', period: 6, group: 3, difficulty: 4,
    color: '#d4a017', badge: '🌟',
    desc: '用于钐钴永磁体和癌症放射治疗'
  },
  {
    z: 63, symbol: 'Eu', name: '铕', nameEn: 'Europium',
    category: 'lanthanide', period: 6, group: 3, difficulty: 4,
    color: '#d4a017', badge: '🌟',
    desc: '用于制造红色荧光粉，是彩色电视的关键材料'
  },
  {
    z: 64, symbol: 'Gd', name: '钆', nameEn: 'Gadolinium',
    category: 'lanthanide', period: 6, group: 3, difficulty: 4,
    color: '#d4a017', badge: '🌟',
    desc: 'MRI造影剂的重要成分，具有特殊磁性质'
  },
  {
    z: 65, symbol: 'Tb', name: '铽', nameEn: 'Terbium',
    category: 'lanthanide', period: 6, group: 3, difficulty: 4,
    color: '#d4a017', badge: '🌟',
    desc: '用于绿色荧光粉和节能灯，Tb-Dy合金用于声纳'
  },
  {
    z: 66, symbol: 'Dy', name: '镝', nameEn: 'Dysprosium',
    category: 'lanthanide', period: 6, group: 3, difficulty: 4,
    color: '#d4a017', badge: '🌟',
    desc: '用于高性能钕铁硼磁体添加和核反应堆控制棒'
  },
  {
    z: 67, symbol: 'Ho', name: '钬', nameEn: 'Holmium',
    category: 'lanthanide', period: 6, group: 3, difficulty: 4,
    color: '#d4a017', badge: '🌟',
    desc: '拥有已知元素中最高的磁矩，用于磁极片'
  },
  {
    z: 68, symbol: 'Er', name: '铒', nameEn: 'Erbium',
    category: 'lanthanide', period: 6, group: 3, difficulty: 4,
    color: '#d4a017', badge: '🌟',
    desc: '掺铒光纤放大器是光纤通信的核心技术'
  },
  {
    z: 69, symbol: 'Tm', name: '铥', nameEn: 'Thulium',
    category: 'lanthanide', period: 6, group: 3, difficulty: 4,
    color: '#d4a017', badge: '🌟',
    desc: '最稀少的镧系元素之一，用于便携式X射线设备'
  },
  {
    z: 70, symbol: 'Yb', name: '镱', nameEn: 'Ytterbium',
    category: 'lanthanide', period: 6, group: 3, difficulty: 4,
    color: '#d4a017', badge: '🌟',
    desc: '用于不锈钢改进和某些激光器的掺杂材料'
  },
  {
    z: 71, symbol: 'Lu', name: '镥', nameEn: 'Lutetium',
    category: 'lanthanide', period: 6, group: 3, difficulty: 4,
    color: '#d4a017', badge: '🌟',
  ...
  // 锕系元素 (89-103)
  {
    z: 89, symbol: 'Ac', name: '锕', nameEn: 'Actinium',
    category: 'actinide', period: 7, group: 3, difficulty: 5,
    color: '#b91c1c', badge: '☢️',
    desc: '锕系元素之首，具有强放射性，发出蓝白光'
  },
  {
    z: 90, symbol: 'Th', name: '钍', nameEn: 'Thorium',
    category: 'actinide', period: 7, group: 3, difficulty: 5,
    color: '#b91c1c', badge: '☢️',
    desc: '潜在的核燃料，储量比铀更丰富'
  },
  {
    z: 91, symbol: 'Pa', name: '镤', nameEn: 'Protactinium',
    category: 'actinide', period: 7, group: 3, difficulty: 5,
    color: '#b91c1c', badge: '☢️',
    desc: '极其稀少的放射性元素，在铀矿中以微量存在'
  },
  {
    z: 92, symbol: 'U', name: '铀', nameEn: 'Uranium',
    category: 'actinide', period: 7, group: 3, difficulty: 5,
    color: '#b91c1c', badge: '☢️',
    desc: '核能发电和核武器的主要原料'
  },
  {
    z: 93, symbol: 'Np', name: '镎', nameEn: 'Neptunium',
    category: 'actinide', period: 7, group: 3, difficulty: 5,
    color: '#b91c1c', badge: '☢️',
    desc: '第一个超铀元素，以海王星命名'
  },
  {
    z: 94, symbol: 'Pu', name: '钚', nameEn: 'Plutonium',
    category: 'actinide', period: 7, group: 3, difficulty: 5,
    color: '#b91c1c', badge: '☢️',
    desc: '核武器和太空探测器核电池的关键材料'
  },
  {
    z: 95, symbol: 'Am', name: '镅', nameEn: 'Americium',
    category: 'actinide', period: 7, group: 3, difficulty: 5,
    color: '#b91c1c', badge: '☢️',
    desc: '家用烟雾探测器中的放射性源，以美洲命名'
  },
  {
    z: 96, symbol: 'Cm', name: '锔', nameEn: 'Curium',
    category: 'actinide', period: 7, group: 3, difficulty: 5,
    color: '#b91c1c', badge: '☢️',
    desc: '以居里夫妇命名，用于深空探测器的同位素热源'
  },
  {
    z: 97, symbol: 'Bk', name: '锫', nameEn: 'Berkelium',
    category: 'actinide', period: 7, group: 3, difficulty: 5,
    color: '#b91c1c', badge: '☢️',
    desc: '以伯克利命名，首次在回旋加速器中合成'
  },
  {
    z: 98, symbol: 'Cf', name: '锎', nameEn: 'Californium',
    category: 'actinide', period: 7, group: 3, difficulty: 5,
    color: '#b91c1c', badge: '☢️',
    desc: '极强的中子发射源，用于核反应堆启动和癌症治疗'
  },
  {
    z: 99, symbol: 'Es', name: '锿', nameEn: 'Einsteinium',
    category: 'actinide', period: 7, group: 3, difficulty: 5,
    color: '#b91c1c', badge: '☢️',
    desc: '以爱因斯坦命名，首次在氢弹试验残骸中发现'
  },
  {
    z: 100, symbol: 'Fm', name: '镄', nameEn: 'Fermium',
    category: 'actinide', period: 7, group: 3, difficulty: 5,
    color: '#b91c1c', badge: '☢️',
    desc: '以费米命名，首次在氢弹爆炸产物中合成'
  },
  {
    z: 101, symbol: 'Md', name: '钔', nameEn: 'Mendelevium',
    category: 'actinide', period: 7, group: 3, difficulty: 5,
    color: '#b91c1c', badge: '☢️',
    desc: '以门捷列夫命名，元素周期表发现者'
  },
  {
    z: 102, symbol: 'No', name: '锘', nameEn: 'Nobelium',
    category: 'actinide', period: 7, group: 3, difficulty: 5,
    color: '#b91c1c', badge: '☢️',
    desc: '以诺贝尔命名，通过核反应人工合成'
  },
  {
    z: 103, symbol: 'Lr', name: '铹', nameEn: 'Lawrencium',
    category: 'actinide', period: 7, group: 3, difficulty: 5,
    color: '#b91c1c', badge: '☢️',
